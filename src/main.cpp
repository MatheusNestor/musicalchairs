...
int main() { // linha do código original
 ...
 // linha do código original
    ...
    if (id != -1) {
        std::cout << "\nO Jogador " << id << " foi o último sobrevivente da disputa!\n";
        std::cout << "\n🏆 Fim do jogo! O Último jogador restante é o vencedor! Parabéns, jogador número " << id << " 🏆\n\n"; // consertar precisa aparecer =  \n🏆 Vencedor: Jogador P" << encontrar_vencedor() << "! Parabéns! 🏆\n\n"
        std::cout << "----------------------------------------------------------\n";
    }
